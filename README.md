...
```
cd existing_repo
git remote add origin https://gitlab-stud.elka.pw.edu.pl/pdabrow5/pwjc_2023z_g.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-stud.elka.pw.edu.pl/pdabrow5/pwjc_2023z_g/-/settings/integrations)
